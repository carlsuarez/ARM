...
extern uint32_t _coarsepagetables_space_start;
extern uint32_t _coarsepagetables_space_end;
extern uint32_t _l1pagetables_space_start;
extern uint32_t _l1pagetables_space_end;
